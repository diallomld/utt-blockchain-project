			  ...
			  return (
					<div id="addpatient">
						  ...
						  <div className="form-group" style={{marginTop:30}}>
						    <label htmlFor="exampleInputEmail1">ID de votre Compangnie</label>
						    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter ID compagnie"></input>
						 </div>
						 <div className="form-group" >
						  <label htmlFor="exampleInputPassword1">Nom</label>
						    <input type="email" className="form-control"id="exampleInputPassword1" placeholder="Enter votre Nom"></input>
						  </div>
						  <div className="form-group">
						    <label htmlFor="exampleInputemail1">Phone Number</label>
						    <input type="email" className="form-control" id="exampleInputPassword1" placeholder="Enter votre phone"></input>
						  </div>
						  <div className="aab">
