	...
	render() {
		  return (
				...
				<div className="sidenav">
				  ...
				  }} className="btn btn-light">Ajouter les medicaments non couverts</button></h6></center>
				</div>

				{
					...
					?    (<form id="mna" className="abc">	
					  <div className="form-group">
					    <label htmlFor="exampleInputEmail1">les medicaments non couverts</label>
					    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter les medicaments non couverts"></input>
					 </div>
					  <div className="aab">
